...
#        'views/assets.xml', odoo13
        ...
        'views/call_types_views.xml',
        'views/views_work_center_location.xml',
        'views/symptoms_views.xml',
        'views/defects_view.xml',
        "views/location_dept_views.xml",
        "views/questionnare_views.xml",
        "views/product_service_type_views.xml",
        "views/customer_city_views.xml",
       
        
        # 'views/extend_views_machine_support.xml',
    ],
    'installable' : True,
    'application' : False,
}
