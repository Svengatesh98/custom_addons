...

{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ""
            'bi_pos_default_customer/static/src/overrides/model/models.js',
            'bi_pos_default_customer/static/src/overrides/model/partner_list.js',
            'views/pos_customer_list.xml',
